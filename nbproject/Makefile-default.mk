...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/MAPPproject.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=PIR.c lcd_utilities.c delays_utilities.c UltraSound.c keypad_utilities.c LockMotor.c MotorFunction.c BuzzOne.c newmain.c butbuzz.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/PIR.p1 ${OBJECTDIR}/lcd_utilities.p1 ${OBJECTDIR}/delays_utilities.p1 ${OBJECTDIR}/UltraSound.p1 ${OBJECTDIR}/keypad_utilities.p1 ${OBJECTDIR}/LockMotor.p1 ${OBJECTDIR}/MotorFunction.p1 ${OBJECTDIR}/BuzzOne.p1 ${OBJECTDIR}/newmain.p1 ${OBJECTDIR}/butbuzz.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/PIR.p1.d ${OBJECTDIR}/lcd_utilities.p1.d ${OBJECTDIR}/delays_utilities.p1.d ${OBJECTDIR}/UltraSound.p1.d ${OBJECTDIR}/keypad_utilities.p1.d ${OBJECTDIR}/LockMotor.p1.d ${OBJECTDIR}/MotorFunction.p1.d ${OBJECTDIR}/BuzzOne.p1.d ${OBJECTDIR}/newmain.p1.d ${OBJECTDIR}/butbuzz.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/PIR.p1 ${OBJECTDIR}/lcd_utilities.p1 ${OBJECTDIR}/delays_utilities.p1 ${OBJECTDIR}/UltraSound.p1 ${OBJECTDIR}/keypad_utilities.p1 ${OBJECTDIR}/LockMotor.p1 ${OBJECTDIR}/MotorFunction.p1 ${OBJECTDIR}/BuzzOne.p1 ${OBJECTDIR}/newmain.p1 ${OBJECTDIR}/butbuzz.p1

# Source Files
SOURCEFILES=PIR.c lcd_utilities.c delays_utilities.c UltraSound.c keypad_utilities.c LockMotor.c MotorFunction.c BuzzOne.c newmain.c butbuzz.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/MAPPproject.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/butbuzz.p1: butbuzz.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/butbuzz.p1.d 
	@${RM} ${OBJECTDIR}/butbuzz.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=icd3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=1000 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/butbuzz.p1  butbuzz.c 
	@-${MV} ${OBJECTDIR}/butbuzz.d ${OBJECTDIR}/butbuzz.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/butbuzz.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/MAPPproject.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/MAPPproject.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=icd3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=1000 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     --rom=default,-7dc0-7fff --ram=default,-3f4-3ff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/MAPPproject.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/MAPPproject.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/MAPPproject.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/MAPPproject.X.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=1000 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/MAPPproject.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
